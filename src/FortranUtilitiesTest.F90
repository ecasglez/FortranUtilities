PROGRAM FortranUtilitiesTest
   ...
   CALL test('zfill', zfill('text', 7_i8) == '000text')
   CALL test('zfill', zfill('text', 7_i16) == '000text')
   CALL test('zfill', zfill('text', 7_i32) == '000text')
   CALL test('zfill', zfill('text', 7_i64) == '000text')
   CALL test('zfill', zfill('text', -2_i8) == 'text')
   CALL test('zfill', zfill('text', -2_i16) == 'text')
   CALL test('zfill', zfill('text', -2_i32) == 'text')
   CALL test('zfill', zfill('text', -2_i64) == 'text')
   CALL test('zfill', zfill('text', 2_i8) == 'text')
   CALL test('zfill', zfill('text', 2_i16) == 'text')
   CALL test('zfill', zfill('text', 2_i32) == 'text')
   CALL test('zfill', zfill('text', 2_i64) == 'text')
   CALL test('zfill', zfill('text', 4_i8) == 'text')
   CALL test('zfill', zfill('text', 4_i16) == 'text')
   CALL test('zfill', zfill('text', 4_i32) == 'text')
   CALL test('zfill', zfill('text', 4_i64) == 'text')
   ...
   CALL test('num2str',num2str(-65.889_sp,'(E10.3)') == '-0.659E+02')
   CALL test('int2str0',int2str0(5_i8,9_i8) == '000000005')
   CALL test('int2str0',int2str0(5_i16,9_i16) == '000000005')
   CALL test('int2str0',int2str0(5_i32,9_i32) == '000000005')
   CALL test('int2str0',int2str0(5_i64,9_i64) == '000000005')
   CALL test('int2str0',int2str0(5_i8,1_i8) == '5')
   CALL test('int2str0',int2str0(5_i16,1_i16) == '5')
   CALL test('int2str0',int2str0(5_i32,1_i32) == '5')
   CALL test('int2str0',int2str0(5_i64,1_i64) == '5')
   CALL test('int2str0',int2str0(0,3) == '000')
