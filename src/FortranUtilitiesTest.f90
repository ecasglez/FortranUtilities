PROGRAM FortranUtilitiesTest
   ...
   CALL test(ABS(variance(vecSp) - 3.5_sp) < 1E-10)
   CALL test(ABS(variance(vecDp) - 3.5_dp) < 1E-10)
   CALL test(ABS(variance(vecQp) - 3.5_qp) < 1E-10)
   CALL test(ABS(stdev(vecSp) - 1.87082875_sp) < 1E-10)
   CALL test(ABS(stdev(vecDp) - 1.8708286933869707_dp) < 1E-10)
   CALL test(ABS(stdev(vecQp) - 1.87082869338697069279187436615827459_qp) < 1E-10)
   CALL test(ABS(pvariance(vecSp) - 2.91666675_sp) < 1E-10)
   CALL test(ABS(pvariance(vecDp) - 2.9166666666666665_dp) < 1E-10)
   CALL test(ABS(pvariance(vecQp) - 2.91666666666666666666666666666666654_qp) < 1E-10)
   CALL test(ABS(pstdev(vecSp) - 1.70782518_sp) < 1E-10)
   CALL test(ABS(pstdev(vecDp) - 1.7078251276599330_dp) < 1E-10)
   CALL test(ABS(pstdev(vecQp) - 1.70782512765993306387017311342017542_qp) < 1E-10)
